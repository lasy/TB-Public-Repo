...
Original data provided by Clue have been processed and filtered (see `00_TB_data_selection.Rmd`)

! TO DO: in the cycles pre-processing: add # of logs in [-18, -1] and in [0:7]


```{r loading Clue data cycles and users, echo = FALSE}
...
Example of one tracking table:

```{r showing tracking table example}
