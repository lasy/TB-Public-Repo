...
This document presents the data analyses that were performed for the manuscript "Phenotyping menstrual breast tenderness from large-scale self-tracked data: data analysis" by L. Symul, P. Hillard and S Holmes.
