...
```{r cycle_clust_optimal_number exploring number of clusters with clara, fig.width= 10, fig.height= 4, cache = FALSE, eval = TRUE}
...
```{r cycle_clust_optimal_number silhouette summary, cache = FALSE, eval = TRUE}
