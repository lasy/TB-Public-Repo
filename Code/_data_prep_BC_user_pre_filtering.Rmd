...
file.copy(paste0(IO$output_data, "cycles.Rdata"), paste0(IO$tmp_data, "cycles_after_BC_pre_filtering.Rdata"))

save(users, file = paste0(IO$output_data, "users.Rdata") )
file.copy(paste0(IO$output_data, "users.Rdata"), paste0(IO$tmp_data, "user_after_BC_pre_filtering.Rdata"))
```
