...
file.copy(paste0(IO$output_data, "users.Rdata"), paste0(IO$tmp_data, "user_before_BC_pre_filtering.Rdata"))
load(paste0(IO$output_data, "users.Rdata"), verbose = TRUE)
```


```{r data_prep_BC_user_pre_filtering loading cycles}
file.copy(paste0(IO$output_data, "cycles.Rdata"), paste0(IO$tmp_data, "cycles_before_BC_pre_filtering.Rdata"))
