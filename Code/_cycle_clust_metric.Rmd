...
```{r cycle_clust_metric checking the clara implementation}
...
g_distances_Rcpp = ggplot(distance_Rcpp, aes(x = i, y = j, col = dist)) + geom_point(size = 10) + xlab("") + ylab("") + scale_color_gradient(low = "lightblue",high = "tomato", na.value = "transparent")

g_distances_clara = ggplot(distance_clara, aes(x = i, y = j, col = dist)) + geom_point(size = 10) + xlab("") + ylab("") + scale_color_gradient(low = "lightblue",high = "tomato", na.value = "transparent")
#g_distances

grid.arrange(g_distances_Rcpp, g_distances_clara, nrow = 1)
