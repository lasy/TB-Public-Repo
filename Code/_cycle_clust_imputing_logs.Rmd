...
```{r cycle_clust_imputing_logs librairies and stuff, include = FALSE, eval = TRUE}
source("Scripts/00_setup.R")
```


```{r cycle_clust_imputing_logs setup, include=FALSE}
...
```{r cycle_clust_imputing_logs loading d_wide}

load(file = paste0(IO$tmp_data,"d_wide.Rdata"), verbose = TRUE)

```
```{r cycle_clust_imputing_logs imputing logs}
...
```{r cycle_clust_imputing_logs creating d}
